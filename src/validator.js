...
cuando el `string` sea de menor longitud.
  ...
  // Funcion para ingresar los numeros de tarjeta
  
  function validartarjeta(){
    //obtener el valor ingresado en el numero de tarjeta//
    let numerotarjeta = document.getElementById('ntarjeta').value;
...
//si la multiplicacion es mayor a 9 ....
      ...
      if(sumaTarjeta % 10 === 0){
        alert('Tarjeta de Credito Valida, su reserva se ha realizado exitosamente');
      }else{
